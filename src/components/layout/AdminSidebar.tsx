...
import {
  ...
  ChevronRight, Database, GraduationCap, LogOut
} from 'lucide-react';
    ...
    <>
      <aside className="hidden lg:flex w-72 flex-col bg-slate-900 text-white min-h-screen fixed right-0 top-0 z-40">
        ...
        <div className="p-3 border-t border-slate-700 space-y-1">
          <Link href="/dashboard" className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-slate-400 hover:text-white hover:bg-slate-800 transition-colors">
